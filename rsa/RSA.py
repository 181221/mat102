...
# n = 2165411799 tar kvadratroten av det og finner primtall opp til sqrt(n)


def finnRiktigP():
    for i in generate_primes(2, nokkel):
        if tall%i == 0:
            return int(i)

tall = 216541799
nokkel = m.ceil(m.sqrt(216541799))
...
K = [8, 5, 9, 19, 00, 14, 14]  # kodet heisann.
encrypt = RSA_encrypt(n, e, K)  # krypterer heisann
d = mult_inverse((p-1)*(q-1), e)  # den multiplikative inversen er den private nøkkelen
dekryptert = RSA_encrypt(n, d, encrypt)

print("p = {}".format(p))
print("q = {}".format(q))
print("n = {}".format(n))
print("e = {}".format(e))
print("gcd = {}".format(check_key(p, q, e)))  # sjekker om gcd((p-1)*(q-1), e) == 1, hvis ja: ok.
print("heisann: {}".format(K))
print("heisann kryptert: {}".format(encrypt))
print("heisann dekryptert: {}".format(dekryptert))
print("dekryptert {}".format(dekryptert == K))  # returns True

# kryptere fra lærer

learerKryptert = [138938544, 167918735, 143648527, 162290725, 29951859, 205923221, 136395302]
print("Krypert melding fra lærer:    {}".format(learerKryptert))
learerDekrypt = RSA_encrypt(n, d, learerKryptert)
print("Dekrypert fra lærer:    {} ".format(num_to_string(learerDekrypt)))